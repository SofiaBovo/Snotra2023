    ...
    <div class="card-body">
      <div class="row">
          ...
          <div class="col">
            ...
            <input class="form-control" name="domiciliofamilia" value="{{$id->domiciliofamilia}}">
          ...
          <div class="col">
            ...
            <input class="form-control" name="localidadfamilia" value="{{$id->localidadfamilia}}">
          ...
          <div class="col">
            ...
            <input class="form-control" name="provinciafamilia" value="{{$id->provinciafamilia}}">
        ...
        <option value="Masculino" <?php if($id->generofamilia=='Masculino') echo 'selected="selected" ';?>>Masculino
            ...
            <input type="text" name="telefonofamilia" class="form-control" value="{{$id->telefono}}">
