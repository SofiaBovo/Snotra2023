...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class=" col-md-12"> 
        ...
        <div class="card-body">
            <h4><span class="badge badge-info">No se encontraron resultados para los criterios seleccionados en la búsqueda.</span></h4>
        ...
        <div class="row" style="margin-right: 3px; margin-left: 3px;">
          <div class="col">
            ...
            <button class="btn btn-sm btn-success" formaction="{{ route('crearfamilia') }}">Crear familia</button>
            </div>
 ...
 @if ($errors->has('familiar'))
        ...
        <div class="col">
        <h4><small><u>Datos del alumno</u></small></h4>
        </div>
          <div class="row" style="margin-right: 3px; margin-left: 3px;">
            <label>DNI</label>
